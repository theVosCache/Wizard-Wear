                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item me-1">
                        <button class="nav-link"
                                ...
                                type="button" role="tab" @disabled($potions->where('learned_in_year', null)->count() === 0)>
                            Research Potions
                        </button>
                    </li>
                    @foreach($yearList as $yearName => $yearNumber)
                        <li class="nav-item me-1">
                            <button class="nav-link"
                                    ...
                                    type="button" role="tab" @disabled($potions->where('learned_in_year', $yearNumber)->count() === 0)>
                                {{ $yearName }}
                            </button>
                        </li>
                    @endforeach
                    ...
                    <div class="tab-pane active"
                        ...
                        @if($potion)
                            <table class="table table-striped-rows">
                                ...
                                <tr>
                                    <th>Learned in Year</th>
                                    <td>{{ $potion?->learned_in_year }}</td>
                                </tr>
                                <tr>
                                    <th>Effects</th>
                                ...
                                <tr>
                                    <th>Exceptional</th>
                                    <td>{{ $potion?->exceptional }}</td>
                                </tr>
                                <tr>
                                    <th>Galleon Price</th>
                                    <td>{{ $potion?->galleon_price }}</td>
                                </tr>
                            </table>
                        @endif
                    </div>
